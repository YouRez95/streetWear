...
export const queryKeysWorkers = {
  ...
  workplaces: (page: number, limit: number, search: string) => ['workplaces', page, limit, search],
  ...
  weeksCursorRoot: (workplaceId: string) => ['weeks-cursor', workplaceId] as const,
  weeksCursor: (workplaceId: string, take: number, cursor: string, search: string) => [
    'weeks-cursor',
    workplaceId,
    take,
    cursor,
  ...
  yearsCursorRoot: (workplaceId: string) => ['years-cursor', workplaceId] as const,
  yearsCursor: (workplaceId: string, take: number, cursor: string, search: string) => [
    'years-cursor',
    workplaceId,
    take,
    cursor,
  ...
  workers: (
    ...
    search: string
  ) => ['workers', active, page, limit, workplaceId, search],
  ...
  weekRecords: (weekId: string, workplaceId: string) => ['week-records', weekId, workplaceId],
  yearRecords: (year: string | null, workplaceId: string) => ['year-records', year, workplaceId],
  workersSummary: (workplaceId: string, weekId: string) => ['workers-summary', workplaceId, weekId],
...
// export function useWorkPlacesByCursor(take: number, cursor: string, search = '') {
//   return useQuery({
//     queryKey: queryKeysWorkers.workplaceCursor(take, cursor, search),
//     queryFn: () => workersService.getWorkPlacesByCursor({ take, cursor, search }),
//     refetchOnWindowFocus: false,
//     retry: false
//   })
// }
...
export function useCreateWorkPlace() {
  ...
  return useMutation({
    ...
    onSettled: () => {
      queryClient.invalidateQueries({ queryKey: queryKeysWorkers.workplaceRoot, exact: false })
    }
  })
}
...
export function useWorkers(
  ...
  return useQuery({
    queryKey: queryKeysWorkers.workers(active, page, limit, workplaceId, search),
    queryFn: () => workersService.getWorkers({ active, page, limit, workplaceId, search }),
    refetchOnWindowFocus: false,
    retry: false
  })
}
...
export function useCreateWorker() {
  ...
  return useMutation({
    ...
    onSettled: () => {
      queryClient.invalidateQueries({ queryKey: queryKeysWorkers.workersRoot, exact: false })
    }
  })
}
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'worker status has been updated successfully.',
        variant: 'default'
      })
    },
...
export function useWeeksByCursor(workplaceId: string, take: number, search = '') {
  return useInfiniteQuery({
...
export function useCreateWeek() {
  const queryClient = useQueryClient()
  return useMutation({
    mutationFn: ({ weekStart, workplaceId }: { workplaceId: string; weekStart: string }) =>
...
export function useDeleteWeek() {
  ...
  return useMutation({
    mutationFn: ({ workplaceId, weekId }: { workplaceId: string; weekId: string }) =>
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Week record has been updated successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'week record has been deleted successfully.',
        variant: 'default'
      })
    },
    onError: (error) => showErrorToast('Error deleting week', error),
    onSettled: (_, __, variables) => {
      const { weekId, workplaceId } = variables
      queryClient.invalidateQueries({ queryKey: queryKeysWorkers.weekRecords(weekId, workplaceId) })
      queryClient.invalidateQueries({
        queryKey: ['worker-records'],
        exact: false
      })
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'week record has been created successfully.',
        variant: 'default'
      })
    },
...
export function useYearsByCursor(workplaceId: string, take: number, search = '') {
  return useInfiniteQuery({
...
export function useWorkerRecords(page: number, limit: number, workerId: string) {
  return useQuery({
