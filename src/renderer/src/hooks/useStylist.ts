import { stylistService } from '@renderer/services/stylistServices'
...
export const queryKeys = {
  ...
  ordersStylist: (seasonId: string, stylistId: string, bonId: string, queryParams: QueryParams) => [
    'ordersStylist',
    seasonId,
    stylistId,
    bonId,
...
export function useStylists(types: string[], page: number, limit: number, search = '') {
  return useQuery({
...
export function useCreateStylist() {
  ...
  return useMutation({
    ...
    onSettled: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.stylistsRoot, exact: false })
      queryClient.invalidateQueries({ queryKey: queryKeys.activeStylists(seasonId), exact: false })
    }
  })
}
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Stylist status has been updated successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Bon stylist has been created successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Order stylist has been created successfully.',
        variant: 'default'
      })
    },
    ...
    onSettled: (_data, _error, variables) => {
      if (!variables) return
      queryClient.invalidateQueries({
        queryKey: queryKeys.ordersStylist(seasonId, variables.stylistId, '', {}),
        exact: false
      })
      queryClient.invalidateQueries({
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Avance stylist has been created successfully.',
        variant: 'default'
      })
    },
    ...
    onSettled: (_data, _error, variables) => {
      if (!variables) return
      queryClient.invalidateQueries({
        queryKey: queryKeys.ordersStylist(seasonId, variables.stylistId || '', variables.bonId, {}),
        exact: false
      })
      queryClient.invalidateQueries({
        queryKey: queryKeys.stylistSummary(seasonId, variables.stylistId || '', variables.bonId),
        exact: false
      })
      queryClient.invalidateQueries({
...
export function useOrdersStylist(stylistId: string, bonId: string, queryParams: QueryParams) {
  const { activeSeason } = useUserStore()
  const seasonId = activeSeason?.id || ''
  ...
  return useQuery({
    ...
    queryFn: () => stylistService.getOrdersStylist(seasonId, stylistId, bonId, queryParams),
    refetchOnWindowFocus: false,
    retry: false,
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Order stylist has been updated successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Order stylist has been deleted successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Avance stylist has been deleted successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Bon stylist has been opened/closed successfully.',
        variant: 'default'
      })
    },
    onError: (error) => showErrorToast('Error opening/closing bon stylist', error),
    onSettled: () => {
      queryClient.invalidateQueries({
        queryKey: queryKeys.activeStylists(seasonId),
        exact: false
...
export function useDeleteBonStylist() {
  ...
  return useMutation({
    mutationFn: (bonId: string) => stylistService.deleteBonStylist(bonId, seasonId),
    onSuccess: async (data) => {
      if (data.status === 'failed') {
        toast({
      ...
      toast({
        ...
        description: data.message || 'Bon stylist has been deleted successfully.',
        variant: 'default'
      })
    },
