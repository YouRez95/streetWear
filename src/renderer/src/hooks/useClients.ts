...
export const queryKeys = {
  ...
  ordersClient: (seasonId: string, clientId: string, bonId: string, queryParams?: QueryParams) => [
    'ordersClient',
    seasonId,
    clientId,
    bonId,
...
export function useActiveClients(openBon: boolean = true, closedBon: boolean = false) {
  const { activeSeason } = useUserStore()
  return useQuery({
    queryKey: [...queryKeys.activeClients(activeSeason?.id || ''), openBon, closedBon],
    queryFn: () => {
      if (!activeSeason) {
      ...
      return clientService.getActiveClients(activeSeason.id, openBon, closedBon)
    },
    refetchOnWindowFocus: false,
    retry: false
  })
...
export function useOrdersClient(clientId: string, bonId: string, queryParams: QueryParams) {
  ...
  return useQuery({
    ...
    queryFn: () => clientService.getOrdersClient(seasonId, clientId, bonId, queryParams),
    refetchOnWindowFocus: false,
    retry: false,
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Order client has been created successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Avance client has been created successfully.',
        variant: 'default'
      })
    },
    ...
    onSettled: (_data, _error, variables) => {
      if (!variables) return
      queryClient.invalidateQueries({
        queryKey: queryKeys.ordersClient(seasonId, variables.clientId || '', variables.bonId, {}),
        exact: false
      })
      queryClient.invalidateQueries({
        queryKey: queryKeys.clientSummary(seasonId, variables.clientId || '', variables.bonId),
        exact: false
      })
      queryClient.invalidateQueries({
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Bon client has been opened/closed successfully.',
        variant: 'default'
      })
    },
    onError: (error) => showErrorToast('Error opening/closing bon client', error),
    onSettled: () => {
      queryClient.invalidateQueries({
        queryKey: queryKeys.activeClients(seasonId),
        exact: false
...
export function useDeleteBonClient() {
  ...
  return useMutation({
    mutationFn: (bonId: string) => clientService.deleteBonClient(bonId, seasonId),
    onSuccess: async (data) => {
      if (data.status === 'failed') {
        toast({
      ...
      toast({
        ...
        description: data.message || 'Bon client has been deleted successfully.',
        variant: 'default'
      })
    },
...
export function useUpdateOrderClient() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      clientService.updateOrderClient({ bonId, clientId, orderId, formData, seasonId }),
    onSuccess: async (data) => {
      if (data.status === 'failed') {
        toast({
      ...
      toast({
        ...
        description: data.message || 'Order client has been updated successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Order client has been deleted successfully.',
        variant: 'default'
      })
    },
  ...
  return useMutation({
    ...
    onSuccess: async (data) => {
      ...
      toast({
        ...
        description: data.message || 'Avance client has been deleted successfully.',
        variant: 'default'
      })
    },
