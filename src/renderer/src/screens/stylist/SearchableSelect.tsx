...
export function SearchableSelect({
  ...
  return (
    ...
    >
      <SelectTrigger
        className={`border-background/50 border rounded-md p-3 data-[placeholder]:text-background/35 ${className}`}
      >
      ...
      <SelectContent className="max-h-[300px]">
        ...
        <div className="max-h-[250px] overflow-y-auto py-3">
          {filteredOptions.length === 0 ? (
            <div className="p-2 text-center text-background/35 text-sm">No results found</div>
          ) : (
