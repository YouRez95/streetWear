...
import { useCreateUser } from '@renderer/hooks/useUsers'
import { validateUserForm } from '@renderer/utils'
      ...
      <DialogContent className="sm:max-w-[750px] bg-foreground text-base">
        <DialogHeader>
          ...
          <DialogDescription className="text-background/80">
            Créer un nouvel utilisateur et leur assigner un rôle. Vous pouvez également ajouter une
            photo de profil.
          </DialogDescription>
        </DialogHeader>
