...
import TableWorkPlace from './TableWorkplace'
// import { CreateUserDialog } from './CreateUserDialog'
// import TableUsers from './TableUsers'

export default function TabWorkPlace() {
    ...
    <div className="flex flex-col h-full">
      <header className="flex justify-between items-start px-7 pt-7">
        <div className="flex flex-col gap-5">
          <h1 className="text-xl font-medium">Atelier</h1>
          <p className="">Gérer vos atelier</p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center">
        <Suspense fallback={<LoadingSuspense />}>
          <TableWorkPlace searchTerm={searchTerm} />
