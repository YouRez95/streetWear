...
import { useCreateStylist } from '@renderer/hooks/useStylist'
...
export function CreateStylistDialog({ open, onOpenChange }: CreateStylistDialogProps) {
      ...
      <DialogContent className="sm:max-w-[750px] bg-foreground text-base">
        <DialogHeader>
          ...
          <DialogDescription className="text-background/80">
            Créer un nouveau styliste en remplissant les informations ci-dessous.
          </DialogDescription>
        </DialogHeader>
