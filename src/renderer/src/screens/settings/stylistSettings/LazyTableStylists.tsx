...
import { useUpdateStylistStatus } from '@renderer/hooks/useStylist'
        ...
        {stylists.map((stylist, index) => (
          <TableRow key={stylist.id} className="h-[55px]">
            ...
            <TableCell className="h-full">
              <div className="flex items-center gap-2 h-full">{stylist.name}</div>
            </TableCell>
            <TableCell className="">{formatDateToDDMMYYYY(stylist.createdAt)}</TableCell>
