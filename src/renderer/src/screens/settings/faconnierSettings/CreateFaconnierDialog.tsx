...
import { useCreateFaconnier } from '@renderer/hooks/useFaconnier'
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[750px] bg-foreground text-base">
        <DialogHeader>
          <DialogTitle>Créer un nouveau faconnier</DialogTitle>
          <DialogDescription className="text-background/80">
            Créer un nouveau faconnier en remplissant les informations ci-dessous.
          </DialogDescription>
        </DialogHeader>
