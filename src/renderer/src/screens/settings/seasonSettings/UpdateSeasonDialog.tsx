...
import { useUpdateSeason } from '@renderer/hooks/useSeason'
...
export default function UpdateSeasonDialog({ season, open, closeDialog }: UpdateSeasonDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    updateSeasonMutation.mutate({...seasonData, isClosed: false}, {
      onSuccess: (data) => {
      ...
      onError: (error) => {
        setError(error.message || 'Une erreur est survenue lors de la mise à jour de la saison')
      }
    })
  }
