...
import { useUpdateClientStatus } from '@renderer/hooks/useClients'
        ...
        {clients.map((client, index) => (
          <TableRow key={client.name} className="h-[55px]">
            ...
            <TableCell className="h-full">
              <div className="flex items-center gap-2 h-full">{client.name}</div>
            </TableCell>
            <TableCell className="">{formatDateToDDMMYYYY(client.createdAt)}</TableCell>
