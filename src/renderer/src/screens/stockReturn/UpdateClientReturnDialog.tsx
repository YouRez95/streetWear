...
import { useUpdateClientReturnStock } from '@renderer/hooks/useReturnStock'
      ...
      <DialogContent className="sm:max-w-[500px] bg-foreground">
        <DialogHeader>
          ...
          <DialogDescription className="text-background text-base">
            Modifiez la quantité retournée. L'ancienne quantité était <b>{stockReturn.quantity}</b>.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          <Button variant="ghost" className="border-[2px] text-base" onClick={() => setOpen(false)}>
            Annuler
          </Button>
          <Button variant="default" className="text-base" onClick={handleConfirm}>
            Confirmer
          </Button>
        </DialogFooter>
      </DialogContent>
