...
import { Eye, MinusSquare, Pencil, PlusSquare, Trash2 } from 'lucide-react'
        ...
        <TableBody className="text-base border">
          ...
          {productsData?.products.map((product) => (
            <Fragment key={product.id}>
              <TableRow className="h-[55px] hover:shadow-sm transition-all">
                <TableCell
                  className="font-medium"
                  onClick={() => handleShowNestedTable(product.id)}
                >
                  {nestedTable === product.id ? (
                    <MinusSquare className="w-6 h-6 cursor-pointer text-background/70" />
                  ) : (
                    <PlusSquare className="w-6 h-6 cursor-pointer text-background/70" />
                  )}
                </TableCell>
                      ...
                      <Table className="text-base w-full bg-muted-foreground">
                        <TableHeader className="text-background bg-tableHead border">
                          <TableRow className="text-base">
                            ...
                            <TableHead className="text-background">Numéro de bon</TableHead>
                            <TableHead className="text-background">Date</TableHead>
                            <TableHead className="text-background">Pcs</TableHead>
                            <TableHead className="text-background">Retourné</TableHead>
                            <TableHead className="text-background">Restant</TableHead>
                          ...
                          {product.FaconnierOrderItems.length > 0 &&
                            product.FaconnierOrderItems.map((item) => (
                              <TableRow className="h-[55px]" key={item.id}>
                                ...
                                <TableCell>{item.quantity_sent - item.quantity_returned}</TableCell>
                                <TableCell>
