...
import clientsIcon from '@renderer/assets/icons/client-icon.svg'
import producersIcon from '@renderer/assets/icons/producer-icon-1.svg'
import stylistIcon from '@renderer/assets/icons/stylists-icon.svg'
