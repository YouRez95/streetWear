...
export default function ProductSearch({ setSearch, search }: ProductSearchProps) {
  ...
  const [openTransferMultipleProductsToClient, setOpenTransferMultipleProductsToClient] =
    useState(false)
  return (
    <div className="flex justify-end items-center gap-2 mb-5">
      ...
      <CreateProductDialog open={openCreateProductDialog} setOpen={setOpenCreateProductDialog} />
