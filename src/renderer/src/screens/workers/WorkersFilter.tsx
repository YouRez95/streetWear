...
export const WorkersFilter = () => {
  ...
  const handleChangeWeekId = ({ weekId, weekName }: { weekId: string; weekName: string }) => {
  ...
  return (
    <div className="flex items-start justify-between my-4">
      <div className="flex flex-col gap-2">
        {currentViewInWeekly === 'workplaces' ? (
          <>
            ...
            <SelectWeekFilter value={weekId} onValueChange={handleChangeWeekId} />
          </>
        ) : (
          <SelectWorkerFilter
            value={workerId}
      ...
      <div className="flex gap-2 items-center">
        {currentViewInWeekly === 'workplaces' && (
          <>
            <CreateWeekDialog open={createWeekOpen} setOpen={setCreateWeekOpen} />
            <AddWorkerDialog />
            {weekId && (
              <DeleteWeekDialog
            ...
            {weekId && (
              <UpdateWeekDialog open={openUpdateWeekDialog} setOpen={setOpenUpdateWeekDialog} />
            )}
          </>
        )}
        <FilterButton />
