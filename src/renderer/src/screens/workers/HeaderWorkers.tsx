        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          {isPending && (
            <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20">
              ...
              <p className="text-sm text-white font-medium">Synchronisation...</p>
            </div>
          )}
        </div>
        ...
        {currentView === 'weekly' && data?.summary && !isPending && (
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
              ...
              <p className="text-sm font-bold text-white">{summaryData.totalRegularHours || 0}h</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Heures Supplémentaires</p>
              <p className="text-sm font-bold text-white">{summaryData.totalOvertimeHours || 0}h</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Semaines Travaillées</p>
              <p className="text-sm font-bold text-white">{summaryData.totalWeeks || 0}</p>
            </div>
          </div>
        )}
      </div>
