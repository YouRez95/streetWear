...
import { useSummaryWorker } from '@renderer/hooks/useWorkers'
      ...
      <div className="relative px-6 py-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm font-medium">Résumé complet des performances</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <div className="bg-white/15 backdrop-blur-md rounded-xl px-4 py-3 border border-white/20 shadow-lg">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-medium text-blue-100">Semaines travaillées</p>
              ...
              <div className="bg-white/15 backdrop-blur-md rounded-xl px-4 py-3 border border-white/20 shadow-lg">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-white">
                      {isPending ? '...' : `${summaryData.totalSpent.toFixed(0)} DHS`}
                    </p>
                  </div>
                </div>
              </div>
        ...
        {isPending && (
          <div className="mt-6 flex items-center justify-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 border border-white/20 w-fit">
            ...
            <p className="text-sm text-white font-medium">Chargement du résumé...</p>
          </div>
        )}
        ...
        {!isPending && data?.summary && (
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-3 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Heures Totales</p>
              <p className="text-lg font-bold text-white">{totalHours.toFixed(1)}h</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-3 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Heures Régulières</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-3 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Heures Supplémentaires</p>
              <p className="text-lg font-bold text-white">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-3 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Semaines Travaillées</p>
              <p className="text-lg font-bold text-white">{summaryData.totalWeeks}</p>
            </div>

            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-3 border border-white/20">
              <p className="text-xs text-blue-200 font-medium">Avances Totales</p>
              <p className="text-lg font-bold text-white">
