...
export default function DropDownSeasons() {
  ...
  const { activeSeason, seasons, setActiveSeason, updateSeasons } = useUserStore()

  console.log('render dropdown seasons', data)
  ...
  if (!isLoading && !seasons.length) return <p className="text-background/50">No seasons found</p>
